...
from .models import (FavoriteRecipes, Ingredient, IngredientAmount, Recipe,
                     ShopList, Tag)
from .utils import get_favorites_list, get_ingredients, get_subscriptons_list
...
def recipe_page(request, recipe_id):
    ...
    return render(
        ...
        {'recipe': recipe, 'ingredients': ingredients,
         'tags': tags, 'index': index, 'favorites_list': favorites_list,
         'subscriptons_list': subscriptons_list})
...
def shop_list_page(request):
    shop = True
    return render(
        request, 'shopList.html', {'shop': shop})
